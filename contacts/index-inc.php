...
<div class="b-contacts">
		<div class="b-block clearfix">
			<div class="b-contacts-left">
				<div class="b-contacts-item address">
					<h3>Адрес:</h3>
					<div><?=includeArea("address")?></div>
				</div>
				<div class="b-contacts-item work">
					<h3>График работы:</h3>
					<div><?=includeArea("contacts-work")?></div>
				</div>
				...
				<div class="b-contacts-item requisites">
					...
					<div><?=includeArea("requisites")?></div>
				</div>
			</div>
	...
	<div class="b-contacts-bottom">
		<h2 class="b-title">Приходите к нам за отпуском</h2>
